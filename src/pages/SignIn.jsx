...
export default function SignIn() {
  ...
  return (
    <section>
      <h1 className="text-3xl font-semibold text-center mt-6">Sign In</h1>
          ...
          <form>
            ...
            <div className="relative mb-6">
              <input
                ...
                className="w-full px-4 py-2 text-xl text-gray-700 bg-white rounded border-gray-300 transition ease-in-out duration-150"
              />
              {showPassword ? (
                <AiFillEyeInvisible
